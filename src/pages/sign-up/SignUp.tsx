      ...
      <View style={styles.contentCenter}>
        ...
        <View style={styles.form}>
          <TextField
            ...
            startIcon={<Ionicons size={25} color="blue" name="pencil" />}
          />
          ...
          <TextField
            ...
            startIcon={
              <Ionicons size={25} color="blue" name="pencil-outline" />
            }
          />
          ...
          <TextField
            ...
            containerStyles={{ marginTop: 15 }}
            startIcon={<Ionicons size={25} color="blue" name="person" />}
          />
          ...
          <TextField
            ...
            containerStyles={{ marginTop: 15 }}
            startIcon={<Ionicons size={25} name="key" color="blue" />}
            endIcon={
              <Ionicons
                size={25}
                color="blue"
